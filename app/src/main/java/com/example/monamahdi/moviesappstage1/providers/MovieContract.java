package com.example.monamahdi.moviesappstage1.providers;

import android.net.Uri;
import android.provider.BaseColumns;

import com.example.monamahdi.moviesappstage1.database.DatabaseHandler;

/**
 * Created by mona.mahdi on 5/27/2018.
 */

public class MovieContract {

    public static final String SCHEME = "content://";
    public static final String AUTHORITY = "com.example.monamahdi.moviesappstage1";
